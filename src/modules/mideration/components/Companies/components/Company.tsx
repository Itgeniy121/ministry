    ...
    <div className="w-[1271px] h-[345px] pt-[40px] px-[51px] flex flex-row justify-between items-start bg-white rounded-[10px] mt-[41px]">
        <div className="flex flex-col justify-start items-start">
            ...
            <div className="flex flex-row mt-[21px] mb-[29px]">
                <div className="px-[26px] bg-[#F0F3FE] py-[4px] rounded-[10px] mr-[11px]"><p className="h1-20-400-inter !text-[#466BE1]">React</p></div>
                <div className="px-[26px] bg-[#F0F3FE] py-[4px] rounded-[10px] mr-[11px]"><p className="h1-20-400-inter !text-[#466BE1]">FRONTEND</p></div>
                <div className="px-[26px] bg-[#F0F3FE] py-[4px] rounded-[10px] mr-[11px]"><p className="h1-20-400-inter !text-[#466BE1]">BACKEND</p></div>
            </div>
            ...
            <div className="flex flex-row mt-[11px]">
                ...
                <button className="w-[249px] h-[54px] rounded-[10px] bg-[#F0F3FE]" onClick={openModal}><p className="h1-25-400-golos !text-[#466BE1]">Надо доработать</p></button>

            </div>
        </div>
        <div className="flex flex-col w-[520px] h-[231px]">
            <h1 className="h1-30-400-golos !text-[#0064DC] mb-[11px]">О компании</h1>
