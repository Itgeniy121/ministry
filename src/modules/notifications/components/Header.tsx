  ...
  return (
    <div className="w-full h-[122px] flex flex-row justify-between items-center max-s:flex-col max-s:items-start">
        <div className="flex flex-row justify-center items-center pl-[82px] max-conf:pl-[20px] max-md:flex-col max-md:items-start">
          ...
          <div className="flex flex-row justify-between items-center w-[630px] ml-[68px] max-xlfooter:w-[250px] max-conf:ml-[20px] max-md:ml-[0px] max-md:mt-[10px]">
            ...
            <p className="h1-16-400-golos max-xlfooter:text-[12px]">Заказы</p>
            <p className="h1-16-400-golos max-xlfooter:text-[12px]">Проекты</p>
            <p className="h1-16-400-golos max-xlfooter:text-[12px]">Поддержка</p>
            <p className="h1-16-400-golos max-xlfooter:text-[12px]">Уведомления (1)</p>
          </div>
        </div>
